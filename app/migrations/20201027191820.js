...
const template = {
  name: 'PTI Email template from NS-Firm Confirmation (Converted)',
  type: 'Quote',
  template: `
...
const migration = () => mongo.connect(configuration)
  ...
  .then((db) => {
    ...
    return lspCol.findOne({ name: 'PTI' })
      .then(lsp =>
        templatesCol.findOne({ name: 'PTI Email template from NS-Firm Confirmation (Converted)', lspId: lsp._id })
          .then((dbTemplate) => {
