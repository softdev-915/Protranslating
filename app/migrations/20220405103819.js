      ...
      <div class="bigip-pdf-country-table-container no-filing">
        {{#if ipPatent.claimsTranslationFees.length}}
          <table class="bigip-pdf-instant-quote-table">
            <thead>
              <tr>
                <th class="bigip-pdf-country-header">LANGUAGE</th>
            ...
            <tbody>
              {{#each ipPatent.claimsTranslationFees}}
                <tr>
                  <td>{{language}}</td>
                  <td>{{../requestCurrencySymbol}} {{#numberToCurrency calculatedFee 2}} {{/numberToCurrency}}</td>
                </tr>
              {{/each}}
            </tbody>
          </table>
        {{/if}}
        {{#if ipPatent.countries.length}} 
          <table class="bigip-pdf-instant-quote-table">
            <thead>
              <tr>
