          ...
          <div class="d-flex align-items-center">
            <template v-if="currentStep === maxSteps - 1">
              ...
              <div class="order-control">
                <ip-button class="order-button" type="filled" data-e2e-type="submit-order" @click.native="saveOrder">Submit order</ip-button>
              </div>
            </template>
            <div
              v-else
      ...
      <template>
        ...
        <div class="ip-modal-body">
          ...
          <div class="ip-modal-body__controls">
            <ip-button class="mr-4" @click.native="closeModal"
              >Cancel</ip-button
            >
            <ip-button type="filled" @click.native="reset">Discard</ip-button>
          </div>
        </div>
      </template>
    </ip-modal>
