...
export default {
  ...
  computed: {
    ...
    preSegmentSource() {
      return _.get(this, 'segmentDetails.preTmSegment.source.text', '');
    },
    preSegmentTarget() {
      return _.get(this, 'segmentDetails.preTmSegment.target.text', '');
    },
    postSegmentSource() {
      return _.get(this, 'segmentDetails.postTmSegment.source.text', '');
    },
    postSegmentTarget() {
      return _.get(this, 'segmentDetails.postTmSegment.target.text', '');
    },
  },
  methods: {
    async fetchDetails() {
