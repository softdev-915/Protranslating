<template>
  <div class="container-fluid" data-e2e-type="portalcat-settings">
    <div class="row">
      <div class="col-12 col-md-6">
        <div class="form-group row align-items-center">
          <label class="col-12 col-md-4" data-e2e-type="mt-threshold-label">MT Threshold (%)</label>
          <div class="col-12 col-md-8" :class="{'has-danger': errors.has('mtThreshold')}">
            <input
              type="number"
              name="mtThreshold"
              class="form-control"
              ...
              v-validate="'mtThreshold'"
              :disabled="!canEdit"
              data-e2e-type="mt-threshold-input" />
            <div class="form-control-feedback" data-e2e-type="mt-threshold-error" v-if="errors.has('mtThreshold')">
    ...
    <template v-if="isValidCompanyId">
      <h6>SRX File Management</h6>
      <sr-management :resourcesService="resourcesService" :companyId="companyId" :languages="languages" />
      <h6>Termbases</h6>
      <tb-management :resourcesService="resourcesService" :companyId="companyId" :languages="languages" />
      <h6>Translation Memories</h6>
      <tm-management :resourcesService="resourcesService" :companyId="companyId" :languages="languages" />
    </template>
  </div>
</template>
