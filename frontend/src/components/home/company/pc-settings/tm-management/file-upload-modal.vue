<template>
  <b-modal size="lg" hide-header-close :no-fade="true" ref="modal" @close="hide()" data-e2e-type="file-upload-modal">
        ...
        <div class="row align-items-center">
          ...
          <div class="col-12 col-md-2">
            ...
            <form ref="fileInputForm" class="d-none">
              <input ref="fileUploadInput" type="file" @change="onFileSelect($event)" data-e2e-type="file-input" accept=".tmx" />
            </form>
          </div>
        </div>
